...
One-time global setup. Compiles a fast native hook binary (via `bun build --compile`) and registers it as a Claude Code PreToolUse hook. Also installs shell completions. Requires [Bun](https://bun.sh).

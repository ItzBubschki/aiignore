...
// Portable command strings using $HOME for settings.json (shell-expanded at runtime)
export const HOOK_COMMAND = "$HOME/.claude/hooks/" + HOOK_BINARY_NAME;
export const HOOK_SCRIPT_COMMAND = 'node "$HOME/.claude/hooks/' + HOOK_BINARY_NAME + '.js"';
...
export const VERSION_CHECK_COMMAND = 'node "$HOME/.claude/hooks/' + VERSION_CHECK_SCRIPT_NAME + '"';

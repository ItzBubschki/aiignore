...
export const HOOK_COMMAND = HOOK_INSTALL_PATH;
export const HOOK_SCRIPT_COMMAND = `node "${HOOK_SCRIPT_INSTALL_PATH}"`;
...
export const VERSION_CHECK_COMMAND = `node "${VERSION_CHECK_INSTALL_PATH}"`;
